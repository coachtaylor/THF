...
// Re-export personal records types
...
export interface Profile {
  ...
  date_of_birth?: Date; // Date of birth for age-based safety rules and COPPA compliance
  ...
  hrt_injection_start_date?: Date; // First injection date for calculating biweekly/monthly schedules
